...
Acerca_de::Acerca_de(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticBitmap1 = new wxStaticBitmap(this, ID_STATICBITMAP1, wxBitmap(wxImage(_T(".\\images\\gnu.png")).Rescale(wxSize(120,168).GetWidth(),wxSize(120,168).GetHeight())), wxPoint(96,16), wxSize(120,168), wxSIMPLE_BORDER, _T("ID_STATICBITMAP1"));
